...
@Injectable() //To insert a socket for use in a Component it needs to be fit for DI, meaning this Class is a wrapper around a websocket that gets docorated with @Injectable.
